...
/**
 * running tests on all the methods in my activity.
 * author Ryan Litwin
 * version 10-28-19
 */
public class CustomerTest {
   ...
   /**
    * a test that tests the setLocation method
    * in my activity.
    */
   ...
   /**
    * runs a second test on the setLocation
   ...
   /**
    * runs a test on the changeBalance method.
    */
   ...
   /**
    * runs a test to see if the output string works.
    */
   ...
   /**
    * test that compares customer balances.
    */
   ...
   /**
    * a second test that compares customer balances,
    * which customer 2 has a bigger balance.
    */
   ...
   /**
    * a third test that compares customr balances,
    * which customer 1 has the bigger balance.
    */
